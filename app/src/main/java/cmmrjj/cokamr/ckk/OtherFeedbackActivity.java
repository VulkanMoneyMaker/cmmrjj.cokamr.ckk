...
public class OtherFeedbackActivity extends AppCompatActivity {
    private static final String TAG = OtherFeedbackActivity.class.getSimpleName();
    ...
    public static Intent getFeedbackActivityIntent(Context context) {
        return new Intent(context, OtherFeedbackActivity.class);
    }
}
